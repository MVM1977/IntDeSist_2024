...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Consultar Status | Mesa de Entrada &amp; UI Framework</title>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Listado de Registros <small>| Mesa de Entrada</small></h3>
                        </div>
                        <div class="block-content block-content-full">
                            <!-- DataTables init on table by adding .js-dataTable-full class, functionality initialized in js/pages/be_tables_datatables.js -->
                            <table id="registros_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                                <thead>
                                    <tr>
