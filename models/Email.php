<?php
    ...
    class Email extends PHPMailer{
        ...
        public function solicitud($reg_id,$usu_nom,$usu_ape){
            $this->IsSMTP();
            $this->Host = 'smtp.office365.com';
            $this->Port = 587;
            $this->SMTPAuth = true;
            ...
            $this->Password = $this->tu_password = "aqui la clave";
            $this->SMTPSecure = 'tls';
            $this->From = $this->tu_email="zensite@zensitec.com";
            $this->FromName = $this->tu_nombre="Nueva Solicitud";
            $this->CharSet='UTF8';
            $this->addAddress("mvanesamorales@hotmail.com");
            $this->WordWrap = 50;
            $this->IsHTML(true);
            $this->Subject = "Nueva Solicitud";
                ...
                $cuerpo = str_replace('lblnumx',$reg_id,$cuerpo);
            $this->Body = $cuerpo;
            $this->IsHTML(true);
